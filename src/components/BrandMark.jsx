export default function BrandMark({ compact = false }) {
  return (
    <div className="flex items-center justify-center gap-3" aria-label="Nonsuch inspired brand mark">
      ...
      {!compact && (
        <div className="text-left">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-gold">Nonsuch</p>
