export default function Glass({ beerLevel, foamLevel, challenge, pouring = false, overflow = false, compact = false }) {
  ...
  const beerTargetRange = challenge.beerTargetRange || [82, 88];
  const targetY = 14 + (100 - beerTargetRange[1]) * 1.76;
  const targetHeight = (beerTargetRange[1] - beerTargetRange[0]) * 1.76;
